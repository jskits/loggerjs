...
const zhDocsCatalog = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "`@loggerjs/browser` 与 `@loggerjs/node` 根入口是 compatible 聚合入口；需要 v1 稳定候选边界时优先使用 stable subpath。",
...
> ${zhGeneratedReferencePlainNotice}
