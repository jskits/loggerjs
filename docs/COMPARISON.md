...
| Automatic browser capture | ✅ broad suite | ❌ none checked | ❌ none checked | ❌ none checked | ❌ none checked |
| Automatic Node collection | ✅ broad suite | 🧩 ecosystem | ⚠️ exceptions/rejections | ✅ framework packages | ⚠️ stream/custom |
...
- LoggerJS does not beat Pino on the direct Node JSON line hot path.
