...
| [Browser Support Export](https://github.com/jskits/loggerjs/tree/main/examples/browser-support-export) | Browser IndexedDB support log store with session ZIP export and localStorage spill. | `@loggerjs/browser`, `@loggerjs/core`, `@loggerjs/processors` | `build`, `clean`, `dev`, `typecheck` |
