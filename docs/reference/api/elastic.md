...
description: "Public declaration report for @loggerjs/elastic."
---
...
Source report: [api-reports/loggerjs-elastic.api.md](https://github.com/jskits/loggerjs/blob/main/api-reports/loggerjs-elastic.api.md).
