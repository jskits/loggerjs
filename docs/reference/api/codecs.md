...
description: "Public declaration report for @loggerjs/codecs."
---
...
Source report: [api-reports/loggerjs-codecs.api.md](https://github.com/jskits/loggerjs/blob/main/api-reports/loggerjs-codecs.api.md).
