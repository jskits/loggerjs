...
description: "Public declaration report for @loggerjs/processors."
---
...
Source report: [api-reports/loggerjs-processors.api.md](https://github.com/jskits/loggerjs/blob/main/api-reports/loggerjs-processors.api.md).
