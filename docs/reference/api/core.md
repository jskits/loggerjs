...
description: "Public declaration report for @loggerjs/core."
---
...
Source report: [api-reports/loggerjs-core.api.md](https://github.com/jskits/loggerjs/blob/main/api-reports/loggerjs-core.api.md).
