...
description: "Public declaration report for @loggerjs/node."
---
...
Source report: [api-reports/loggerjs-node.api.md](https://github.com/jskits/loggerjs/blob/main/api-reports/loggerjs-node.api.md).
