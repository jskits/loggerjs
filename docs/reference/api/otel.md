...
description: "Public declaration report for @loggerjs/otel."
---
...
Source report: [api-reports/loggerjs-otel.api.md](https://github.com/jskits/loggerjs/blob/main/api-reports/loggerjs-otel.api.md).
