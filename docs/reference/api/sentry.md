...
description: "Public declaration report for @loggerjs/sentry."
---
...
Source report: [api-reports/loggerjs-sentry.api.md](https://github.com/jskits/loggerjs/blob/main/api-reports/loggerjs-sentry.api.md).
