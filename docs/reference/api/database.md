...
description: "Public declaration report for @loggerjs/database."
---
...
Source report: [api-reports/loggerjs-database.api.md](https://github.com/jskits/loggerjs/blob/main/api-reports/loggerjs-database.api.md).
