...
description: "@loggerjs/browser 的公共声明报告。"
---
...
源报告：[api-reports/loggerjs-browser.api.md](https://github.com/jskits/loggerjs/blob/main/api-reports/loggerjs-browser.api.md).
