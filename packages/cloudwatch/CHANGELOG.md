...
- No CloudWatch runtime source changes landed between the `0.5.5` and `0.5.6` package releases.
...
- No CloudWatch runtime source changes landed between the `0.5.4` and `0.5.5` package releases.
- Updated dependencies:
  - @loggerjs/core@0.5.5
...
- Version alignment for repository tag `v0.3.0`; no CloudWatch transport API changes.
- Updated dependency `@loggerjs/core` to the matching release.

## 0.1.0 - 2026-06-13 (repository tag `v0.2.0`)

- Version alignment for repository tag `v0.2.0`; no CloudWatch transport API changes.
- Updated dependency `@loggerjs/core` to the matching release.

## 0.0.2 - 2026-06-12 (package tag `@loggerjs/cloudwatch@0.0.2`)

- Republished through the explicit provenance publishing path.
- Updated dependency `@loggerjs/core` to the matching release.

## 0.0.1 - 2026-06-12 (package tag `@loggerjs/cloudwatch@0.0.1`)

- Initial CloudWatch Logs transport package.
- Updated dependency `@loggerjs/core` to the matching release.
